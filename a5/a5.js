...
posxMaterial = new THREE.MeshBasicMaterial( {map: posyTexture, side:THREE.DoubleSide });
posxWall = new THREE.Mesh(wallGeometry, posxMaterial);
posxWall.position.y = size;
posxWall.rotation.x = -Math.PI / 2;
posxWall.rotation.y = -Math.PI / 1;
scene.add(posxWall);

  // negxWall:  negative x-axis wall
posxMaterial = new THREE.MeshBasicMaterial( {map: negxTexture, side:THREE.DoubleSide });
posxWall = new THREE.Mesh(wallGeometry, posxMaterial);
posxWall.position.x = -size;
posxWall.rotation.y = Math.PI / 2;
scene.add(posxWall);
  // negyWall:  negative y-axis wall
posxMaterial = new THREE.MeshBasicMaterial( {map: negyTexture, side:THREE.DoubleSide });
posxWall = new THREE.Mesh(wallGeometry, posxMaterial);
posxWall.position.y = -size;
posxWall.rotation.x = Math.PI / 2;
posxWall.rotation.y = -Math.PI / 1;
...
poszWall.position.x = 0;
poszWall.rotation.y = -Math.PI / 1;
poszWall.position.z = size;
scene.add(poszWall);
  // negzWall:  negative z-axis wallf
poszMaterial = new THREE.MeshBasicMaterial( {map: negzTexture, side:THREE.DoubleSide });
poszWall = new THREE.Mesh(wallGeometry, poszMaterial);
poszWall.position.x = 0;
poszWall.position.y = 0;
poszWall.position.z = -size;
poszWall.rotation.x = 0;
poszWall.rotation.y = -Math.PI/1*2;
poszWall.rotation.z = 0;
scene.add(poszWall);
/////////////////////////////////////	
